  ...
  return (
    <>
      ...
      <div className="products">
        ...
        />
        <Product on
          onAddToCart={handleAddToCart} image="/clothing/item02.jpg" name="Halenka" price={1200} />
        <Product on
          onAddToCart={handleAddToCart} image="/clothing/item03.jpg" name="Svetr" price={1500} />
        <Product on
          onAddToCart={handleAddToCart} image="/clothing/item04.jpg" name="Mikina" price={800} />
      </div>
    </>
  );
};
